...
# Example usage
control_path = dir+r"\HGPLVM_output_repository\model_summaries\MCCV\GPDM_MCCV_CMU_50\7_ID_MCCV_f1_dist_msad_Movements CMU_GPDMM_Bayesian_50"
test_paths = [
    dir+r"\HGPLVM_output_repository\model_summaries\MCCV\RNN_MCCV_CMU\MCCV_f1_dist_msad_Movements CMU_Bayesian_RNN",
    dir+r"\HGPLVM_output_repository\model_summaries\MCCV\transformer_MCCV_CMU\MCCV_f1_dist_msad_Movements CMU_Bayesian_Transformer",
    dir+r"\HGPLVM_output_repository\model_summaries\MCCV\VAE_MCCV_CMU\MCCV_f1_dist_msad_Movements CMU_Bayesian_VAE"
]

results = run_mccv_analysis(control_path, test_paths, test_type=test_type)
#print_raw_data(results)
save_results_to_csv(results, dir+r"\HGPLVM_output_repository\MCCV\\" + data_set + "\\" + test_type + "\\" )