...
def process_file(filepath):
    ...
    print(f"Raw data (first 5 rows):\n{second_table[['iteration', 'score', 'f1', 'msad']].head()}")
    ...
    print(f"Best row:\n{best_row[['iteration', 'score', 'f1', 'msad']]}")
...
def run_mccv_analysis(control_path, test_paths, test_type='ttest'):
    ...
    results = {metric: {} for metric in ['score', 'f1', 'msad']}
...
test_type = 'ttest'
# Example usage
control_path = r"C:\Users\Jesse\Documents\Python\GPy\HGPLVM_output_repository\model_summaries\MCCV\GPDM_MCCV_CMU_50\7_ID_MCCV_f1_dist_msad_Movements CMU_GPDMM_Bayesian_50"
test_paths = [
    r"C:\Users\Jesse\Documents\Python\GPy\HGPLVM_output_repository\model_summaries\MCCV\GPDM_MCCV_CMU\MCCV_f1_dist_msad_Movements CMU_GPDMM_Bayesian_50",
    r"C:\Users\Jesse\Documents\Python\GPy\HGPLVM_output_repository\model_summaries\MCCV\GPDM_MCCV_CMU_50_50\MCCV_f1_dist_msad_Movements CMU_GPDMM_Bayesian_50",
    r"C:\Users\Jesse\Documents\Python\GPy\HGPLVM_output_repository\model_summaries\MCCV\RNN_MCCV_CMU\MCCV_f1_dist_msad_Movements CMU_Bayesian_RNN",
    r"C:\Users\Jesse\Documents\Python\GPy\HGPLVM_output_repository\model_summaries\MCCV\transformer_MCCV_CMU\MCCV_f1_dist_msad_Movements CMU_Bayesian_Transformer",
    r"C:\Users\Jesse\Documents\Python\GPy\HGPLVM_output_repository\model_summaries\MCCV\VAE_MCCV_CMU\MCCV_f1_dist_msad_Movements CMU_Bayesian_VAE"
]

results = run_mccv_analysis(control_path, test_paths, test_type=test_type)
#print_raw_data(results)
save_results_to_csv(results, r"C:\Users\Jesse\Documents\Python\GPy\HGPLVM_output_repository\MCCV\\" + data_set + "\\" + test_type + "\\" )