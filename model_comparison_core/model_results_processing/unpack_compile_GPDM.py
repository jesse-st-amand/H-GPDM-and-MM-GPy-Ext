...
def main():
    ...
    print(f"Importing parameters from: model_comparison_core.model_parameters.{name}")
    ...
    full_path = os.path.join(base_path, name, output_dir_name)
    ...
    compile_main(unpacked_dir, parameters_to_include, grouping_params, baseline, output_file)
