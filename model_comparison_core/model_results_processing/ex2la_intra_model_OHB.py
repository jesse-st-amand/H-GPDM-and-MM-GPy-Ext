...
def main():
    ...
    excel_path = r"C:\Users\Jesse\Documents\LaTex\GPDMM ICANN\sections\results\figures\data\BM_CMU_intra_data.xlsx"
    output_path = r"C:\Users\Jesse\Documents\LaTex\GPDMM ICANN\sections\results\figures\model_vars_table.tex"
    
    # TABLE CONTENT SETTINGS
    caption = "GPDMM parameter comparison for top-performing variations of the numbers of layers, order of the dynamics, and back-constraints (BCs)."  # Table caption
    label = "tab:model-variations"                   # Label for cross-referencing
    
    # Define parameter columns for tables without a Model column
    parameter_columns = ['Layers', 'order', 'DR', 'BC', 'Geo']  # Set to None to use Model column or auto-detect
