from model_results_processing.compile_data_funcs_internal import main
import datetime
import os
...
def CRI(model_dict, csv_path='', **kwargs):
    ...
    output_path = os.path.abspath(
        'C:/Users/Jesse/Documents/Python/GPy/HGPLVM_output_repository/compiled_model_summaries/' + out_path )
