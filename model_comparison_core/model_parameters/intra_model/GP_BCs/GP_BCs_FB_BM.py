...
bc_name = 'multi w GP geo'
geometry = 'fourier_basis'
geo_params = (8,9,10,11)
order = 1
BC_param_constraints = (['variance','A','alpha','phi','f'],['variance','A'],['variance'],['variance','A','alpha'],['variance','A','f'],['variance','A','phi'],['variance','A','f','phi'],['variance','A','alpha','phi'],['variance','A','f','alpha'])
mapping = 'GPLVM'
pred_group = 0
