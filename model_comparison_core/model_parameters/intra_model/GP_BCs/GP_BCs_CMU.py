...
geometry = ('ellipse','toroid')
geo_params = ""
order = 1
BC_param_constraints = (['variance','A','R','n','r'],['variance','A'],['variance'],['variance','A','R'],['variance','A','r'],['variance','A','n'],['variance','A','r','n'],['variance','A','R','n'],['variance','A','r','R'])
mapping = 'GPLVM'
pred_group = 0
