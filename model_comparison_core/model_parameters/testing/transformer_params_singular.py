...
# ------ Architecture END
## ------ Simulations
output_dir_name = 'temp_transformer_singular'
...
fold_start = 0
fold_end = 6
fold_num = 1#tuple(np.arange(fold_start,fold_end,1))
num_sims = 1
...
hidden_size_multiplier = 8 ### hidden_size = num_heads*hidden_size_multiplier
num_layers = 2
num_heads = 2
dropout = .2
