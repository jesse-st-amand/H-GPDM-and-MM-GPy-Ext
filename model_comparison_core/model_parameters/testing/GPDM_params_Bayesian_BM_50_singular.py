...
##
output_dir_name = 'temp_'+data_set_name+'_GPDMM_Bayesian_50'
#space.append(Integer(10,20,name='arch_dict:top_node_dict:attr_dict:input_dim'))
#space.append(Integer(8,9,name='arch_dict:top_node_dict:attr_dict:input_dim'))
if space is not None:
    space.append(Categorical([False],name='BC_dict:ARD'))

max_iters = 50
num_folds = 1#2*(num_sequences_per_action_train+num_sequences_per_action_test)
fold_start = 0
fold_end = 1
fold_list = [0]
fold_num = 0#(0,1)
...
score_rate = int(max_iters*2)
##


input_dim = 7#(15,16)#, 21, 24, 27)#11#tuple(np.arange(5,20))
