...
##
output_dir_name = 'temp_'+data_set_name+'_Bayesian_VAE'
#space.append(Integer(200,600,name='arch_dict:hidden_size'))
#space.append(Integer(2,3,name='arch_dict:latent_size'))
...
hidden_size = 335#(600,800,100)
latent_size = 11#(4, 8, 16)
