...
##
output_dir_name = 'DOF_f1_dist_msad_'+data_set_name+'_Bayesian_Transformer'
space.append(Integer(30,45,name='arch_dict:hidden_size_multiplier'))
...
hidden_size_multiplier = 8#(8, 16, 32) ### hidden_size = num_heads*hidden_size_multiplier
num_layers = 2#(2, 3, 4)
num_heads = 2#(2, 4, 8)
dropout = .3#(.1,.2,.3)
