...
from .kern_2nd_order import CombinationKernel, Kern
...
class Add(CombinationKernel):
    ...
    def _check_exact_psicomp(self):
        ...
        from GPy.kern.src.static import White
        from GPy.kern.src.static import Bias
    ...
    def K(self, X, X2=[None, None], which_parts=None):
        """
