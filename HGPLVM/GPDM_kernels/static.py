...
from .kern_2nd_order import Kern
import numpy as np
...
class Static(Kern):
    def __init__(self, input_dim, seq_eps, variance, active_dims, name):
        super(Static, self).__init__(input_dim, seq_eps, active_dims, name)
