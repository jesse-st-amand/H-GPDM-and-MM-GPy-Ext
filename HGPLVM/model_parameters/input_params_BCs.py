...
## quick ref
input_dim1 = 11
init1 = ('random','PCA','fourier_basis')
bc_name = ('gp map','kernel','multi w GP', 'linear', 'mlp')
geometry = 'none'
...
comparison_name = 'BCs_init_rand_PCA_fourier'
score_type = 'score_PVNPP' #pos_vel_norm_pred_prob
output_dir_name = comparison_name + '_' + score_type + '_' +'dim_'+str(input_dim1)+'_prior_'+prior_name+ '_'+ prior_dynamics +'_len_'+str(seq_len)
notes = ''
