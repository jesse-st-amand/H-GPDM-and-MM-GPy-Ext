...
init1 = 'random'
bc_name = 'gp map geo'
geometry = ('none','chebyshev_basis','zernike_basis','spherical_harmonics_basis','haar_basis','walsh_basis')
...
comparison_name = 'basis2_initial_conditions'
score_type = 'score_PVNPP' #pos_vel_norm_pred_prob
output_dir_name = comparison_name + '_' + score_type + '_' +'dim_'+str(input_dim1)+'_BC_'+bc_name.replace(' ', '_')+'_init_'+init1+'_prior_'+prior_name+ '_'+ prior_dynamics +'_len_'+str(seq_len)
notes = ''
